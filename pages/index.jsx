...
const Home = () => (
  <>
    <NextSeo
      title="Macaron Magic - Luxury Macarons Made by Hand"
      description="Welcome to Macaron Magic - the home of great-tasting, luxurious macarons, made by hand in the Peak District."
    />
    <div>
      <div className="fronLogo">
        <div className="banner">
          <span>Luxury macarons made by hand</span>
          <span>
